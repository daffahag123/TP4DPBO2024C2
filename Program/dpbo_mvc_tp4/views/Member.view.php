<?php
  // Kelas untuk mengatur tampilan Member
  class MemberView {
    // Fungsi untuk menampilkan halaman daftar member
    public function render($data) {
      // URL untuk menambahkan data member baru
      ...
      // Membuat baris tabel untuk setiap data member
      foreach($data as $val) {
    ...
    // Fungsi untuk menampilkan formulir penambahan member
    public function renderAddForm($data) {
      $title = "Tambah";
      $mainTitle = "Member";

      // Data pilihan untuk opsi Channel Youtube
      ...
      // Formulir penambahan data member
      $dataForm = null;
    ...
    // Fungsi untuk menampilkan formulir pengeditan member
    public function renderEditForm($data) {
      $title = "Ubah";
      $mainTitle = "Member";

      // Opsi untuk pilihan Channel Youtube
      ...
      foreach($data['member'] as $val) {
        ...
        // Formulir untuk pengeditan data member
        $dataForm = null;
